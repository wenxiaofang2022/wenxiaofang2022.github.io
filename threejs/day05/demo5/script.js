(function(app) {
  ...
  let metadata = {
    urls: {
      github: '',
      sun: {
        surfaceMaterial: 'imgs/sunSurfaceMaterial.jpg',
        atmosphereMaterial: 'imgs/sunAtmosphereMaterial.png'
      },
      mercury: {
        surfaceMaterial: 'imgs/mercurySurfaceMaterial.jpg'
      },
      venus: {
        surfaceMaterial: 'imgs/venusSurfaceMaterial.jpg'
      },
      earth: {
        normalMaterial: 'imgs/earthSurfaceNormal.jpg',
        surfaceMaterial: 'imgs/earthSurface.jpg',
        specularMaterial: 'imgs/earthSurfaceSpecular.jpg',
        cloudsMaterial: 'imgs/earthAtmosphere.png'
      },
      moon: 'imgs/moon.jpg',
      mars: {
        surfaceMaterial: 'imgs/marsSurfaceMaterial.png'
      },
      jupiter: {
        surfaceMaterial: 'imgs/jupiterSurfaceMaterial.jpg'
      },
      saturn: {
        surfaceMaterial: 'imgs/saturnSurface.jpg',
        ringsMaterial: 'imgs/saturnRings.png'
      },
      uranus: {
        surfaceMaterial: 'imgs/uranusSurfaceMaterial.jpg'
      },
      neptune: {
        surfaceMaterial: 'imgs/neptuneSurfaceMaterial.jpg'
      },
      pluto: {
        surfaceMaterial: 'imgs/plutoSurfaceMaterial.jpg'
      },
    },
