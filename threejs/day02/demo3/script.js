...
},{"./get":3}],2:[function(require,module,exports){
...
},{"./get":3}],5:[function(require,module,exports){
var Get = require('./get');
var get = new Get();
...
var initThree = function() {
  ...
  scene.fog = new THREE.Fog(0x111111, 7000, 10000);
...
var init = function() {
  ...
  for (var i = 0; i < boxNum; i++) {
    var radius = get.randomInt(300, 3000);
    var rad1 = get.radian(get.randomInt(12, -12));
  ...
  for (var i = 0; i < boxArr.length; i++) {
    var r = get.randomInt(0, 255);
    var g = get.randomInt(20, 240);
    var b = get.randomInt(120, 150);
    var verticesLength = boxVertices.length;
    var facesLength = boxFaces.length;
    
    for (var index = 0; index < boxFaces.length; index++) {
      indicesArr[facesLength * 3 * i + index * 3 + 0] = boxFaces[index].a + i * verticesLength;
      indicesArr[facesLength * 3 * i + index * 3 + 1] = boxFaces[index].b + i * verticesLength;
      indicesArr[facesLength * 3 * i + index * 3 + 2] = boxFaces[index].c + i * verticesLength;
    }
...
var render = function() {
  ...
  for (var i = 0; i < boxArr.length; i++) {
    ...
    for (var index = 0; index < boxVertices.length; index++) {
      ...
      verticesArr[verticesLength * 3 * i + index * 3 + 0] = vector.x + boxArr[i].position.x;
      verticesArr[verticesLength * 3 * i + index * 3 + 1] = vector.y + boxArr[i].position.y;
      verticesArr[verticesLength * 3 * i + index * 3 + 2] = vector.z + boxArr[i].position.z;
    }
  }
...
},{"./camera":1,"./debounce":2,"./get":3,"./hemiLight":4,"./mover":6,"./pointLight":7}],6:[function(require,module,exports){
var Get = require('./get');
var get = new Get();
...
},{"./get":3}],7:[function(require,module,exports){
var Get = require('./get');
var get = new Get();
